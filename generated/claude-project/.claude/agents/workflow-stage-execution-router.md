...
Evaluate each approved execution unit against the target registry and assignment rules. Record the selected target, rationale, availability condition, scope, and fallback chain.
